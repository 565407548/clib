...
obj=obj/zcj_disjointSets.o obj/zcj_stack.o obj/zcj_queue.o obj/zcj_tree.o obj/zcj_list.o

bin=bin/test_disjointSets bin/test_stack bin/test_queue bin/test_tree bin/test_list
